...
function Sobre(){
    return (
        <div className="flex flex-col items-center h-screen gap-10" id="sobremim">
            <h1 className="text-amber-300 font-black">SOBRE MIM</h1>
